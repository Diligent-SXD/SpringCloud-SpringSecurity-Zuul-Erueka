...
public class RedisUtil {
     ...
     * 查询username下的刷新时间
     *
     * @param username 查询的key
     * @return HV
     */
    public Object getTokenValidTimeByToken(String username) {
        return redisTemplate.opsForHash().get(username, "tokenValidTime");
    }
    ...
    public Object getTokenByUserName(String username) {
        return redisTemplate.opsForHash().get(username, "username");
    }
     ...
     * @return HV
     */
    public Object getIPByToken(String username) {
        return redisTemplate.opsForHash().get(username, "ip");
    }
     ...
     * @return HV
     */
    public Object getExpirationTimeByToken(String username) {
        return redisTemplate.opsForHash().get(username, "expirationTime");
    }
